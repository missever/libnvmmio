...
struct log_table_struct *alloc_log_table(struct log_table_struct *parent,
                                         int index, enum table_type_enum);
struct log_entry_struct *alloc_log_entry(struct mmap_area_struct *uma,
                                         log_size_t log_size);
