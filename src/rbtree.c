...
static __always_inline void __rb_insert(
    struct rb_node *node, struct rb_root *root, bool newleft,
    struct rb_node **leftmost,
    void (*augment_rotate)(struct rb_node *old, struct rb_node *new)) {
  struct rb_node *parent = rb_red_parent(node), *gparent, *tmp;

  if (newleft) *leftmost = node;
...
static inline void dummy_copy(__attribute__((unused)) struct rb_node *old,
                              __attribute__((unused)) struct rb_node *new) {}
static inline void dummy_rotate(__attribute__((unused)) struct rb_node *old,
                                __attribute__((unused)) struct rb_node *new) {}
...
void rb_erase(struct rb_node *node, struct rb_root *root) {
  ...
  if (rebalance) ____rb_erase_color(rebalance, root, dummy_rotate);
}
